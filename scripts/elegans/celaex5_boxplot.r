...
load('../processed_data/celaex5_model.Rdata')
load('../processed_data/eleg_pop_boxplot.Rdata')

celpot2 <- eleg_geno %>% filter(POS==14852419 | POS==14852825 | POS==14854921) %>% filter(CHROM=="I")
...
q
ggsave("../plots/celaex5_boxplot.png",dpi=300,height=4,width = 12, units = "in")
