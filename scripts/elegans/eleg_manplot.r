...
eleg_genes <- read.delim("../data/elegans/goi/eleg_goi.tsv")
# load independent tests result
total_independent_tests <- read.table("../data/elegans/nemascan_runs/Analysis_Results-20220308/Genotype_Matrix/total_independent_tests.txt", quote="\"", comment.char="", stringsAsFactors=FALSE)
# load processed mapping data. 
processed_mapping <- read.delim("../data/elegans/nemascan_runs/Analysis_Results-20220308/Mapping/Processed/processed_length_AGGREGATE_mapping.tsv", stringsAsFactors=FALSE) %>%
