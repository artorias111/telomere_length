...
genes_in_region <- data.table::fread(glue::glue("../data/elegans/nemascan_runs/Analysis_Results-20220308/Fine_Mappings/Data/length_II_13272357-15257187_bcsq_genes.tsv"))
...
gene_plot
ggsave("../plots2/eleg_fineplot2.png",dpi=300,height=2,width = 7.5, units = "in")