...
genes_in_region <- data.table::fread(glue::glue("../data/briggsae/nemascan_runs/Analysis_Results-20220308/Fine_Mappings/Data/length_I_14312709-15147409_bcsq_genes.tsv"))
